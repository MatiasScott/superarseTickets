<div class="main-content">
	<div class="admin-section">
		...
		<div class="admin-header">
			<div>
				<h3><i class="bi bi-plus-circle"></i> Crear Rol</h3>
				<p class="text-muted">Agregar nuevo rol al sistema</p>
			</div>
		...
		<div class="admin-form">
			<form method="POST" action="<?= base_url('admin/roles') ?>" data-validate>
				<?= csrf_field() ?>
				
				<div class="form-group">
					<label for="nombre"><i class="bi bi-shield"></i> Nombre del rol</label>
					<input type="text" class="form-control" id="nombre" name="nombre" placeholder="Ej: Administrador" required>
				...
				<div class="form-group">
					...
					<textarea class="form-control" id="descripcion" name="descripcion" rows="3" placeholder="Describe el propósito de este rol..."></textarea>

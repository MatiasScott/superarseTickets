console.debug('Modulo relaciones cargado');

document.addEventListener('DOMContentLoaded', () => {
	const table = document.querySelector('[data-relaciones-table]');
	if (!table) return;

	const filters = Array.from(document.querySelectorAll('[data-relaciones-filters] [data-filter]'));
	const rows = Array.from(table.querySelectorAll('tbody tr'));
	const counter = document.querySelector('[data-relaciones-counter]');

console.debug('Modulo academico cargado');

document.addEventListener('DOMContentLoaded', () => {
	const table = document.querySelector('[data-academico-table]');
	if (!table) return;

	const filters = Array.from(document.querySelectorAll('[data-academico-filters] [data-filter]'));
	const rows = Array.from(table.querySelectorAll('tbody tr'));
	const counter = document.querySelector('[data-academico-counter]');
